              ...
              <table class="b-order-cart-table">
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td class="b-order-cart-table__name-cell"><a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="b-order-cart-table__name-link"><?=$arItem['NAME']?></a></td>
                          ...
                          <td class="b-order-cart-table__quantity-cell"><?=$arItem['QUANTITY']?> <?=Loc::getMessage('RS_LIGHTBASKET_ORDER_MEASURE_NAME');?></td>
