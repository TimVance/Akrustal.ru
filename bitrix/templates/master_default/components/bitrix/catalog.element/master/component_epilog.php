...
if($arResult['PREVIEW_TEXT']){
	$arResult['META_TAGS']['OG:DESCRIPTION'] = $arResult['PREVIEW_TEXT'];
}
if($arResult['PREVIEW_PICTURE']){
	$arResult['META_TAGS']['OG:IMAGE'] = $arResult['PREVIEW_PICTURE']['SRC'];
}
\Akrustal\Lib\Utils::setMeta($arResult['META_TAGS']);