(function (window){
	...
	window.JCCatalogItem.prototype = {
      ...
      this.quantityChange();
		...
		// Орлов А. раскомментировано
		 initBasketUrl: function()
		 {
			 this.basketUrl = (this.basketMode === 'ADD' ? this.basketData.add_url : this.basketData.buy_url);
			// Орлов А. закомментировано, нет productType
			 //switch (this.productType)
			 //{
			///	 case 1: // product
			//	 case 2: // set
		...
		basketResult: function(arResult)
		{
			...
			{
				//Орлов А. отключаем авто редирект в корзину при добавлении без всплывающего окна
				//this.basketRedirect();
			}
			else
			{
				...
				if (successful)
				{
					...
					strContent = '<div class="popup-window-data"><div class="popup-window-data-img"><img src="'
						+ strPict + '" height="200" style="max-height:200px"></div><p class="popup-window-data-text">' + this.product.name + '</p></div>';
