...
if (isset($arResult['ITEM']))
{
    ...
    $measureRatio = 1;
    $actualItem['ITEM_MEASURE']['TITLE'] = Loc::getMessage('RS.MASTER.BCI_MASTER.ITEM_MEASURE');
	...
	<div class="product-item-container"
		id="<?=$areaId?>" data-entity="item" itemprop="itemListElement">
		<?
		...
		{
			$jsParams = array(
				'PRODUCT_TYPE' => 0,// $item['CATALOG_TYPE'],
