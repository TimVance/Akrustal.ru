					...
					<div class="main_info font_sm">
						<?if (isset($arProperty["TITLE"])):?>
							<span>
								...
								?>
								<a class="title_stores" href="<?=$arProperty["URL"]?>" data-storehref="<?=$arProperty["URL"]?>" data-iblockhref="<?=$arShops[$arProperty['ID']]['DETAIL_PAGE_URL']?>"> <?=$storeName?></a>
							</span>
						<?endif;?>
						<?if($arParams['FIELDS'] && in_array('PHONE', $arParams['FIELDS']) && isset($arProperty["PHONE"]) && $arProperty["PHONE"]):?><div class="store_phone p10"><?=GetMessage('S_PHONE')?> <?=$arProperty["PHONE"]?></div><?endif;?>
