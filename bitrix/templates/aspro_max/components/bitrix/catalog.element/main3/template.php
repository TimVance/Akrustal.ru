				...
				<div class="product-detail-gallery__container<?=($bVertical ? ' product-detail-gallery__container--vertical' : '');?>">
					...
					<div class="product-detail-gallery__thmb-container text-center">
						<div class="product-detail-gallery__thmb-inner<?=($bVertical ? ' vertical' : '');?>">
							...
							<?if(!$showCustomOffer || empty($arResult['OFFERS_PROP'])):?>
								<?if($countPhoto  > 1):?>
									<div class="product-detail-gallery__slider owl-carousel owl-theme thmb<?=($bVertical ? ' product-detail-gallery__slider--vertical' : '');?><?=($countPhoto > 3 ? ' m-photo' : '');?>" data-size="<?=$countPhoto;?>" data-plugin-options='{"items": "3", "nav": true, "loop": false, "clickTo": ".product-detail-gallery__slider.big", "dots": false, "autoWidth": true, "margin": 10<?//if($bVertical):?>, "mouseDrag": false, "pullDrag": false<?//endif;?><?if($bMagnifier):?>, "magnifier": true<?endif;?>}' style="max-width:<?=ceil((($countPhoto <= 3 ? $countPhoto : 3) * 70) - 10)?>px;">
										<?if($arResult["MORE_PHOTO"]):?>
											<?foreach($arResult["MORE_PHOTO"] as $i => $arImage):?>
								...
								<?endif;?>
							<?else:?>
								<div class="product-detail-gallery__slider owl-carousel owl-theme thmb<?=($bVertical ? ' product-detail-gallery__slider--vertical' : '');?>" data-size="<?=$countPhoto;?>" data-plugin-options='{"items": "3", "nav": true, "loop": false, "clickTo": ".product-detail-gallery__slider.big", "dots": false, "autoWidth": true, "margin": 10<?//if($bVertical):?>, "mouseDrag": false, "pullDrag": false<?//endif;?><?if($bMagnifier):?>, "magnifier": true<?endif;?>}' style="max-width:<?=ceil((($countPhoto <= 3 ? $countPhoto : 3) * 70) - 10)?>px;">
								</div>
							<?endif;?>
						</div>
					</div>
				...
				<div class="flexbox flexbox--row flex-wrap align-items-normal">
					...
					<div class="product-action flex-50">
						<div class="info_item">
									...
									<div class="shadowed-block">
										...
										<?if($arParams["SHOW_DISCOUNT_TIME"]=="Y"){?>
											...
											<?if($arParams['SHOW_DISCOUNT_TIME_EACH_SKU'] != 'Y' || ($arParams['SHOW_DISCOUNT_TIME_EACH_SKU'] == 'Y' && (!$arResult['OFFERS'] || ($arResult['OFFERS'] && $arParams['TYPE_SKU'] != 'TYPE_1')))):?>
												<?\Aspro\Functions\CAsproMax::showDiscountCounter($totalCount, array(), $arQuantityData, $arItem, $strMeasure, 'compact red', $item_id);?>
											<?else:?>
							...
							<?//delivery calculate?>
							<?if($arParams['CALCULATE_DELIVERY'] != 'NOT' && (!$arResult["OFFERS"] || $arParams['TYPE_SKU'] === 'TYPE_1')):?>
