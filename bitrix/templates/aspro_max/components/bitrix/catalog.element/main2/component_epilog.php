					...
					<?if($arParams['DETAIL_LINKED_GOODS_TABS'] != 'N'):?>
						...
						<div class="ordered-block <?=$code?>">
							...
							<?if($templateData['ASSOCIATED'] && $templateData['EXPANDABLES']):?>
								<div class="tabs horizontal-scrolling bottom-line" data-plugin-options='{"axis": "x", "scrollInertia": 200, "snapAmount": 70, "scrollButtons": {"enable": true}}'>
									<ul class="nav nav-tabs">
										<li class="active"><a href="#assoc" data-toggle="tab" class="linked"><?=$arParams["DETAIL_ASSOCIATED_TITLE"];?></a></li>
										<li class=""><a href="#expandables" data-toggle="tab" class="linked"><?=$arParams["DETAIL_EXPANDABLES_TITLE"];?></a></li>
									</ul>
								</div>
			...
			<?if($arParams['SHOW_ASK_BLOCK'] == 'Y'):?>
				<div class="side-block side-block--feedback rounded2 bordered box-shadow colored_theme_hover_bg-block">
					...
					<div class="side-block__bottom side-block__bottom--last">
						<span class="btn btn-lg round-ignore btn-transparent btn-wide font_upper animate-load colored_theme_hover_bg-el has-ripple" data-event="jqm" data-param-form_id="ASK" data-name="ask"><?=($arParams["ASK_TAB"] ? $arParams["ASK_TAB"] : GetMessage("ASK_TAB"))?></span>
					</div>
				</div>
			<?endif;?>
		</div>
