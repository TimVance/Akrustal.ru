...
<?//var_dump($bHideLeftBlock);?>
<?//$arParams["FILTER_NAME"] = 'MAX_LANDING_FILTER';?>
...
<?if($arElement['PROPERTY_FILTER_URL_VALUE'] || $arElement['PROPERTY_SECTION_VALUE']):?>
<?// start catalog section block?>
		...
		<?$APPLICATION->AddViewContent('goods_catalog_block_prolog', $html);//?>
				...
				<?ob_start()//goods_catalog_block ?>
					...
					<?if(!empty($arElement['PROPERTY_SECTION_VALUE']) || !empty($arElement['PROPERTY_FILTER_URL_VALUE']) ):?>
