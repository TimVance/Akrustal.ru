...
?>
<header class="l-head1 <?php if (\Redsign\Master\PageUtils::isHome()) { echo ' l-head1--background'; } else { echo 'l-head1--shade-light'; } ?>"  data-flyhead-start="true">
    <div class="container">
    ...
    <div class="l-head1__menu">
        ...
        <div class="l-head1__search">
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    'AREA_FILE_SHOW' => 'file',
                    'PATH' => '/include/header/search.php'
                )
            ); ?>
        </div>
    </div>
    ...
    <div class="l-head1__background-inner">
        <div class="l-head1__background" style="background-image: url('/include/header/background.png')"></div>
