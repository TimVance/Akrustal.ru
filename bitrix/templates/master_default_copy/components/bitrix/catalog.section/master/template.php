...
<section id="<?=$arParams['TEMPLATE_AJAXID']?>_section">
...
<?php endif; ?>
    ...
    <?php if ($arParams['SHOW_PARENT_NAME'] == 'Y' && strlen($arParams['PARENT_NAME']) > 0): ?>
        <h2 class="l-section__name h3"><?=$arParams['PARENT_NAME']?></h2>
    <?php endif; ?>
...
{
	?>
	<div class="text-center" id="<?=$arParams['TEMPLATE_AJAXID']?>_pagination" data-pagination-num="<?=$navParams['NavNum']?>">
...
if ($arParams['HIDE_SECTION_DESCRIPTION'] !== 'Y' && strlen($arResult['DESCRIPTION']) > 0)
{
    ...
    ?>
		<div class="catalog__descr"><?=$arResult['DESCRIPTION']?></div>
	<?php
    $this->EndViewTarget();
}
?>

<div class="catalog-section" id="<?=$arParams['TEMPLATE_AJAXID']?>_items" data-entity="container-<?=$navParams['NavNum']?>">
	<?
				...
				switch ($rowData['VARIANT'])
				{
					case 0:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								<div class="col col-xs-12 product-item-big-card">
									<div class="row">
										<div class="col-md-12">
											<?
					...
					case 1:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col col-xs-6 product-item-big-card">
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
...
if ($showLazyLoad)
{
	...
	<div class="text-center" style="margin: 15px;">
		<div class="btn btn-default btn-lg" data-use="show-more-<?=$navParams['NavNum']?>">
