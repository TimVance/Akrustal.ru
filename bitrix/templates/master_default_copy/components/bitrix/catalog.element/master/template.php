                            ...
                            foreach ($arParams['TABS_ORDER'] as $blockName) {
                                ...
                                switch ($blockName) {
	                                ...
	                                case 'articles':
		                                ...
		                                >
		                                <?
		                                    include(getTemplatePart($templateFolder.'/include/related/articles.php'));
		                                    $bActiveTab = true;
		                                ?>
                                        </div>
	                                    <?
	                                ...
	                                case 'reviews':
		                                ...
		                                >
			                                <?
			                                include(getTemplatePart($templateFolder.'/include/related/reviews.php'));
			                                $bActiveTab = true;
			                                ?>
		                                </div>
		                                <?
...
*/
		...
		<span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
			...
			<meta itemprop="priceCurrency" content="<?= \Bitrix\Currency\CurrencyManager::getBaseCurrency(); ?>" />
