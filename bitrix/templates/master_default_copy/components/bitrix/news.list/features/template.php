        ...
        <?php foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            <div class="<?=$sItemClass?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                ...
                <a href="<?=$arItem['PROPERTIES'][$arParams['LINK_PROP']]['VALUE']?>"<?php if ($arItem['PROPERTIES'][$arParams['TARGET_PROP']]['VALUE'] != ''): ?> target="_blank"<?php endif; ?>>
                    ...
                    <?php if ($arItem['PROPERTIES'][$arParams['ICON_BODYMOVIN_PROP'][$arItem['IBLOCK_ID']]]['VALUE'] != ''): ?>
                        ...
                        <script>
                            ...
                            var animData = {
                                ...
                                path: '<?=SITE_TEMPLATE_PATH?>/assets/images/icons/svg/<?=$arItem['PROPERTIES'][$arParams['ICON_BODYMOVIN_PROP'][$arItem['IBLOCK_ID']]]['VALUE']?>.json'
                            };
