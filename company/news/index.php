...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_LINK_NEWS_ID" => "69",
		"IBLOCK_LINK_SERVICES_ID" => "71",
		"IBLOCK_LINK_TIZERS_ID" => "59",
		"IBLOCK_LINK_REVIEWS_ID" => "68",
		"IBLOCK_LINK_STAFF_ID" => "65",
		"IBLOCK_LINK_VACANCY_ID" => "51",
		"IBLOCK_LINK_BLOG_ID" => "66",
		"IBLOCK_LINK_PROJECTS_ID" => "64",
		"IBLOCK_LINK_BRANDS_ID" => "79",
		"IBLOCK_LINK_LANDINGS_ID" => "66",
		"BLOCK_SERVICES_NAME" => "",
		"BLOCK_NEWS_NAME" => "",
		"BLOCK_TIZERS_NAME" => "",
		"BLOCK_REVIEWS_NAME" => "",
